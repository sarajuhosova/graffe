...
import com.sarajuhosova.graffe.lang.exception.generation.MissingComponentsException
...
data class Graph(
    ...
    operator fun get(name: String): com.sarajuhosova.graffe.lang.model.dto.Component? =
        if (name !in nodes) null else com.sarajuhosova.graffe.lang.model.dto.Component(
            getNode(name)!!,
            getEdges(name),
            this
        )

    fun getParent(): com.sarajuhosova.graffe.lang.model.dto.Component? =
        // TODO: fix the empty list here!!
        if (parent == null) null else com.sarajuhosova.graffe.lang.model.dto.Component(parent, emptyList(), this)
